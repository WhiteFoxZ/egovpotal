CREATE SCHEMA `egovpotal` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;

CREATE USER 'egovpotal'@'localhost' IDENTIFIED BY 'egovpotal';
GRANT USAGE ON *.* TO 'egovpotal'@'localhost';
GRANT EXECUTE, SELECT, SHOW VIEW, ALTER, ALTER ROUTINE, CREATE, CREATE ROUTINE, CREATE TEMPORARY TABLES, CREATE VIEW, DELETE, DROP, EVENT, INDEX, INSERT, REFERENCES, TRIGGER, UPDATE, LOCK TABLES  ON `egovpotal`.* TO 'egovpotal'@'localhost' WITH GRANT OPTION;
FLUSH PRIVILEGES;
SHOW GRANTS FOR 'egovpotal'@'localhost';
